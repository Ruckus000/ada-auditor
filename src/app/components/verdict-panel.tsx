...
const VERDICTS: Array<{
...
}> = [
  {
    ...
    glossaryKey: 'pass',
    label: 'Pass',
    meaning: 'Evidence was complete, and no rule-based finding failed a Level A or AA success criterion.',
  ...
  },
  {
    ...
    glossaryKey: 'fail',
    label: 'Fail',
    meaning: 'Evidence was complete, and at least one rule-based finding failed a Level A or AA success criterion.',
