...
| **[remediation-test-2026-08-27-results.md](remediation-test-2026-08-27-results.md)** | **The 120-document test.** Conversion delivers and survives audit (31/31 real Word docs, zero invented claims); repair produces conformance whose claims do not (23/28 "green", 2/28 true, 62 false assertions). The reopened STOP stands, strengthened. |
| [remediation-test-predictions-2026-08-27.md](remediation-test-predictions-2026-08-27.md) | The pre-registration. Scored in the results: five called, one miss each direction. |
...
| **[source-fidelity-in-production.md](source-fidelity-in-production.md)** | **The delivered document, held against its own source.** Nothing compared a delivered PDF to the `.docx` it came from — the existing gate compares a PDF with itself. Re-measured on master 2026-09-11: 31/31 converted, **0 assertions**. Its first act on master was to **overturn the 2026-08-27 campaign's headline finding**: the "five list items lost on export" were numbered headings counted twice by this instrument's own source reader, and the heading/item overlap equalled the recorded loss on all four documents. No content was ever lost. What remains is r02's single unexplained item on the legacy `.doc` path, and our own heading re-rank reading as a divergence from the source. |
