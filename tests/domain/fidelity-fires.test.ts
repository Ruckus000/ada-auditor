...
const FAITHFUL_DELIVERY: DocumentStructure = {
  ...
  headingTexts: [],
  figures: [
    { type: 'Figure', alt: 'The borough seal', actualText: null },
    { type: 'Figure', alt: 'A location map', actualText: null },
  ],
  tables: [
...
const DAMAGE: Array<{
  ...
  },
  {
    ...
    break: () => ({
      ...
      delivered: {
        ...FAITHFUL_DELIVERY,
        figures: [...FAITHFUL_DELIVERY.figures, { type: 'Figure', alt: null, actualText: null }],
      },
    }),
  },
  {
